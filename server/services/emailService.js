...
class EmailService {
  ...
  async sendTicketEmail({ order, tickets, customerEmail, customerName }) {
    try {
      ...
      // Use tickets as-is - QR codes should already be generated by PayHero callback
      // If QR codes are missing, they will be skipped (shouldn't happen in normal flow)
      const ticketsWithQR = tickets;
        ...
        .map((ticket, index) => {
          ...
          <div class="card" style="margin-bottom: 16px;">
            ...
            colors.border
              ...
              ${
                ticket.qrCodeUrl
                  ? `<img src="cid:${qrCid}" alt="QR Code for ${ticket.ticketNumber}" style="width: 280px; height: 280px; max-width: 100%; border: 3px solid ${colors.primary}; border-radius: 8px; padding: 12px; background: white; display: block; margin: 0 auto;" />`
