...
const orderSchema = new mongoose.Schema(
  {
    ...
    pricing: {
      ...
      // Transaction fee (separate from service fee)
      transactionFee: {
        type: Number,
        required: false,
        min: 0,
      ...
      // Transaction fee details for admin tracking
...
orderSchema.methods.setAffiliateTracking = function (
  referralCode,
  affiliateId
) {
